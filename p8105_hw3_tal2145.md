...
library(p8105.datasets) data(“brfss\_smart2010”)

brfss\_smart2010 = janitor::clean\_names() %\>% filter(topic == “Overall
Health”) %\>% group\_by(response) %\>% summarize( n\_question =
n(response) ) \# mutate(response = as.factor(response)) %\>%
