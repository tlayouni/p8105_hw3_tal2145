...
There are `r nrow(instacart_aisles)` aisles in the instacart dataset and the aisle that the most items are ordered from is the fresh vegetables followed by fresh fruits then packaged vegetables fruits..  
